...
在批处理中允许以`:XXX来构建一个标号，然后用GOTO XXX跳转到标号:XXX处，`然后执行标号后的命令。  
例：  
![](http://r.photo.store.qq.com/psb?/57f6398e-db93-428d-8871-6d2527ad188f/IGx.G1tshRweRDB2DvRqwoHmBP9kAQADFmzgauCHY1s!/o/dL4AAAAAAAAA&bo=tAA0ALQANAADEDU!)  
